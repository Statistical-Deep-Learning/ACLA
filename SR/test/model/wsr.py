# https://github.com/FVL2020/WSR/blob/master/networks/wsr_arch.py
...
def make_model(args, parent=False):
        return WSR(in_channels=3, out_channels=3, 
                    num_features = 64, num_simdb = 10, 
                    upscale_factor = args.scale[0], act_type='prelu', norm_type=None)



import os
os.environ['CUDA_VISIBLE_DEVICES'] = '0'
model = WSR(in_channels=3, out_channels=3, 
                    num_features = 64, num_simdb = 10, 
                    upscale_factor = 4, act_type='prelu', norm_type=None)
