...
class RFDN(nn.Module):
    def __init__(self, in_nc=3, nf=50, num_modules=6, out_nc=3, upscale=4):
...
# which are named RFDN and RFDN-L. RFDN uses a channel number of 48 while RFDN-L uses a channel number of 52 to ahcieve a better reconstruction quality. We set the number of RFDB to 6 in both RFDN and RFDN-L. 

import os
os.environ['CUDA_VISIBLE_DEVICES'] = '0'
model = RFDN(upscale=4,nf=52)
from torchsummary import summary
summary(model, (3, 320,180), depth=2, verbose=1,   
